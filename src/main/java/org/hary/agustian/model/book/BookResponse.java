...
public class BookResponse {
    ...
    public BookResponse(Integer id, String title, Year year, Integer quantity, Integer borrowPrice, Category category, List<BorrowerDetail> borrowerDetails, List<Author> authors, Publisher publisher) {
        this.id = id;
        this.title = title;
        this.year = year;
